            ...
            <div class="table-responsive">
                <table class="table table-bordered" width="100%" cellspacing="0">
                    <thead class="table-dark">
                        <tr>
                            <th rowspan="2" style="text-align: center;vertical-align: middle;" class="text-center">No
                            </th>
                            <th rowspan="2" style="text-align: center;vertical-align: middle;" class="text-center">
                                Kecamatan</th>
                            <th rowspan="2" style="text-align: center;vertical-align: middle;" class="text-center">
                                Kabupaten</th>
                            <th colspan="<?=$jml_prog ?>" style="text-align: center;vertical-align: middle;"
                                class="text-center">Program Bantuan</th>
                            <th rowspan="2" style="text-align: center;vertical-align: middle;" class="text-center">
                                Jumlah</th>
                        </tr>
                        <tr>
