...
<div class="container-fluid ">
    ...
    <div class="card" style="width: 18rem;">
        <div class="card-body">
            ...
            <button type="button" id="editProfil" name="editProfil" class="btn btn-primary btn-sm" data-toggle="modal"
                data-target="#modalEditProfil">Edit Profile</button>
            <button type="button" id="editPass" name="editPass" class="btn btn-success btn-sm" data-toggle="modal"
                data-target="#modalEditPass">Ganti Password</button>
        </div>
    </div>
...
<div class="modal fade" id="modalEditPass" tabindex="-2" role="dialog" aria-labelledby="modalEditPassTitle"
    aria-hidden="true">
...
<div class="modal fade" id="modalEditProfil" tabindex="-2" role="dialog" aria-labelledby="modalEditProfilTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mt-1" id="nm_pegawai" name="nm_pegawai"
                                value="<?=$user['nm_pegawai'] ?>" required>

                            <label for="nip" class="col-form-label text-dark"> NIP : </label>
                            <input type="text" class="form-control mt-1" id="nip" name="nip" value="<?=$user['nip'] ?>"
                                required>

                            <label for="no_telepon" class="col-form-label text-dark"> No Telephone : </label>
                            <input type="text" class="form-control mt-1" id="no_telepon" name="no_telepon"
                            ...
                            <input type="text" class="form-control mt-1" id="role" name="role"
