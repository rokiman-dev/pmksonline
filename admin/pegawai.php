...
<div class="container-fluid">
    ...
    <div class="card shadow mb-2">
        ...
        <!-- Modal Edit Data -->
        <?php foreach ($pegawai as $row) : ?>
        <div class="modal fade" id="modalEdit<?= $row['id_pegawai'] ?>" tabindex="-2" role="dialog"
