...
<div class="container-fluid">
    ...
    <div class="card shadow mb-2">
        <div class="card-header py-3">
                    ...
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-left"><a class="text-dark2" href="kk_detail.php?id=<?=$row['id_kk'] ?>">
                                        <?=$row['no_kk']; ?></a></td>
                                ...
                                <td class="text-center">
                                    <form method="POST">
                                        ...
                                        <button type="button" id="edit" name="edit" class="btn btn-warning btn-sm"
                                            data-toggle="modal" data-target="#modalEdit<?= $row['id_kk']; ?>">
                                            <i class="fas fa-edit"></i> Edit</button>

                                        <input type="hidden" name="id_kk" value="<?=$row['id_kk'];?>">
                                        <button type="submit" name="hapus" class="btn btn-danger btn-sm"
                                            onclick="return confirm('yakin hapus <?=$row['nm_kpl'] ?>?');">
                                            <i class="fas fa-trash-alt"></i> Delete</button>
                                        <?php endif; ?>

                                        <button type="button" id="pmks" name="pmks" class="btn btn-info btn-sm"
                                            data-toggle="modal" data-target="#modalPmks<?= $row['id_kk']; ?>">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <form>
                                    ...
                                    <div class="form-group">
                                        <label for="nik_kpl" class="col-form-label">NIK</label>
                                        <input type="text" class="form-control mt-1" id="nik_kpl" name="nik_kpl"
                                            required>
                                    </div>

                                    <div class="form-group">
                                        <label for="nm_kpl" class="col-form-label">Nama</label>
                                        <input type="text" class="form-control mt-1" id="nm_kpl" name="nm_kpl" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="tgl_lhr_kpl" class="col-form-label">Tanggal Akses</label>
                                        <input type="date" class="form-control mt-1" id="tgl_lhr_kpl" name="tgl_lhr_kpl"
                                            required>
                                    </div>
                                ...
                                foreach ($kec as $key) :?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="alamat_kpl" name="alamat_kpl"
                                            rows="3"></textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="pekerjaan_kpl" class="col-form-label">Pekerjaan Kepala
                                            Keluarga:</label>
                                        <input type="text" class="form-control mt-1" id="pekerjaan_kpl"
                                            name="pekerjaan_kpl" required>
                                    </div>
            ...
            <!-- Modal Edit Data -->
            <?php foreach ($kk as $row)  : ?>
            <div class="modal fade" id="modalEdit<?=$row['id_kk'] ?>" tabindex="-2" role="dialog"
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <form>
                                    ...
                                    <input type="hidden" name="nik_kpl2" class="form-control"
                                        value="<?=$row['nik_kpl']?>">
                                    <input type="hidden" name="nm_kpl2" class="form-control"
                                        value="<?=$row['nm_kpl']?>">
                                    <input type="hidden" name="tgl_lhr_kpl2" class="form-control"
                                        value="<?=$row['tgl_lhr_kpl']?>">
                                    <input type="hidden" name="id_kec2" class="form-control"
                                        value="<?=$row['id_kec']?>">
                                    <input type="hidden" name="id_desa2" class="form-control"
                                        value="<?=$row['id_desa']?>">
                                    <input type="hidden" name="alamat_kpl2" class="form-control"
                                        value="<?=$row['alamat_kpl']?>">
                                    <input type="hidden" name="pekerjaan_kpl2" class="form-control"
                                        value="<?=$row['pekerjaan_kpl']?>">
                                    <input type="hidden" name="pendidikan_kpl2" class="form-control"
                                        value="<?=$row['pendidikan_kpl']?>">
                                    ...
                                    <div class="form-group">
                                        <label for="no_kk" class="col-form-label">No KK:</label>
                                        <input type="text" class="form-control mt-1" id="no_kk" name="no_kk"
                                            value="<?=$row['no_kk']?>" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="nik_kpl" class="col-form-label">NIK </label>
                                        <input type="text" class="form-control mt-1" id="nik_kpl" name="nik_kpl"
                                            value="<?=$row['nik_kpl']?>" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="nm_kpl" class="col-form-label">Nama </label>
                                        <input type="text" class="form-control mt-1" id="nm_kpl" name="nm_kpl"
                                            value="<?=$row['nm_kpl']?>" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="tgl_lhr_kpl" class="col-form-label">Tanggal Akses</label>
                                        <input type="date" class="form-control mt-1" id="tgl_lhr_kpl" name="tgl_lhr_kpl"
                                            value="<?=$row['tgl_lhr_kpl']?>" required>
                                    </div>
                                ...
                                $kec = query("SELECT a.*,b.* FROM kecamatan a INNER JOIN desa b USING (id_kec)
                                              WHERE a.is_delete=1 AND b.is_delete=1 AND nm_kec!= 'Tidak Ada' ORDER BY a.nm_kec ASC");
                                foreach ($kec as $key) :?>
                                            <option value="<?=$key['id_kec'].'|'.$key['id_desa']?>" <?php  
                                              $kect=$row['nm_kec'];
                                              $des =$row['nm_desa'];
                                              $wil =$kect." - ".$des;
                                    ...
                                    <div class="form-group">
                                        <label for="alamat_kpl">Alamat Lengkap:</label>
                                        <textarea class="form-control" id="alamat_kpl" name="alamat_kpl"
                                            rows="3"><?=$row['alamat_kpl']?></textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="pekerjaan_kpl" class="col-form-label">Pekerjaan Kepala
                                            Keluarga:</label>
                                        <input type="text" class="form-control mt-1" id="pekerjaan_kpl"
                                            name="pekerjaan_kpl" value="<?=$row['pekerjaan_kpl']?>" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="pendidikan_kpl">Pendidikan Kepala Keluarga</label>
                                        <select class="form-control" id="pendidikan_kpl" name="pendidikan_kpl">
                                            <option value="Tidak Sekolah" <?php  if ($row['pendidikan_kpl']=='Tidak Sekolah') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>Tidak Sekolah</option>
                                            <option value="SD" <?php  if ($row['pendidikan_kpl']=='SD') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>SD</option>
                                            <option value="SMP" <?php  if ($row['pendidikan_kpl']=='SMP') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>SMP</option>
                                            <option value="SMA/SMK" <?php  if ($row['pendidikan_kpl']=='SMA/SMK') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>SMA/SMK</option>
                                            <option value="S1" <?php  if ($row['pendidikan_kpl']=='S1') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>S1</option>
            ...
            <!-- Modal Tambah PMKS-->
            <?php foreach ($kk as $row)  : ?>
            <div class="modal fade" id="modalPmks<?=$row['id_kk'] ?>" tabindex="-2" role="dialog"
                aria-labelledby="modalPmksDataTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <form method="post" enctype="multipart/form-data">
                            <div class="modal-header modal-bg" back>
                            ...
                            <div class="modal-body">
                                <form>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mt-1" id="nik_pmks" name="nik_pmks"
                                            value="Tidak Ada" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="nm_pmks" class="col-form-label">Nama PMKS:</label>
                                        <input type="text" class="form-control mt-1" id="nm_pmks" name="nm_pmks"
                                            required>
                                    </div>

                                    <div class="form-group">
                                        <label for="tgl_lhr_pmks" class="col-form-label">Tanggal Akses:</label>
                                        <input type="date" class="form-control mt-1" id="tgl_lhr_pmks"
                                            name="tgl_lhr_pmks" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="wilayah" name="wilayah"
                                            value="<?=$row['id_kec'].' | '.$row['id_desa'];?>">
                                        <input type="text" class="form-control mt-1"
                                            value="<?=$row['nm_kec'].' - '.$row['nm_desa'];?>" readonly>
                                    </div>
                                ...
                                foreach ($kec as $key) :?>
                                    ...
                                    <div class="form-group">
                                        <label for="hubungan" class="col-form-label">Hubungan Kepala Keluarga Dengan
                                            PMKS:</label>
                                        <input type="text" class="form-control mt-1" id="hubungan" name="hubungan"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mt-1" id="nm_ibu_pmks" name="nm_ibu_pmks"
                                            required>
                                    </div>
