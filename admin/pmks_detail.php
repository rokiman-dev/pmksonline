...
<div class="modal fade" id="modalEditPmks" tabindex="-2" role="dialog" aria-labelledby="modalEditPmksDataTitle"
    aria-hidden="true">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <input type="hidden" name="tgl_lhr_pmks2" class="form-control"
                            value="<?=$row1['tgl_lhr_pmks']?>">
                        <input type="hidden" name="hubungan2" class="form-control" value="<?=$row1['hubungan']?>">
                        <input type="hidden" name="jns_klm_pmks2" class="form-control"
                            value="<?=$row1['jns_klm_pmks']?>">
                        <input type="hidden" name="nm_ibu_pmks2" class="form-control" value="<?=$row1['nm_ibu_pmks']?>">
                        <input type="hidden" name="pendidikan_pmks2" class="form-control"
                            value="<?=$row1['pendidikan_pmks']?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" id="wilayah" name="wilayah"
                                value="<?=$row1['id_kec'].' | '.$row1['id_desa'];?>">
                            <input type="text" class="form-control mt-1"
                                value="<?=$row1['nm_kec'].' - '.$row1['nm_desa'];?>" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="hubungan" name="hubungan">
                                <option value="Kepala Keluarga" <?php  if ($row1['hubungan']=='Kepala Keluarga') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>Kepala Keluarga</option>
                                <option value="Suami" <?php  if ($row1['hubungan']=='Suami') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>Suami</option>
                                <option value="Istri" <?php  if ($row1['hubungan']=='Istri') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>Istri</option>
                                <option value="Anak" <?php  if ($row1['hubungan']=='Anak') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>Anak</option>
                                <option value="Orang Tua" <?php  if ($row1['hubungan']=='Orang Tua') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>Orang Tua</option>
                                <option value="Keluarga" <?php  if ($row1['hubungan']=='Keluarga') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>Keluarga</option>
                                <option value="Lainnya" <?php  if ($row1['hubungan']=='Lainnya') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>Lainnya</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="jns_klm_pmks" name="jns_klm_pmks">
                                <option value="Laki-Laki" <?php  if ($row1['jns_klm_pmks']=='Laki-Laki') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>Laki-Laki</option>
                                <option value="Perempuan" <?php  if ($row1['jns_klm_pmks']=='Perempuan') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>Perempuan</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mt-1" id="nm_ibu_pmks" name="nm_ibu_pmks"
                                value="<?=$row1['nm_ibu_pmks']?>" required>
                        </div>

                        <div class="form-group">
                            <label for="pendidikan_pmks">Pendidikan PMKS</label>
                            <select class="form-control" id="pendidikan_pmks" name="pendidikan_pmks">
                                <option value="Tidak Sekolah" <?php  if ($row1['pendidikan_pmks']=='Tidak Sekolah') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>Tidak Sekolah</option>
                                <option value="SD" <?php  if ($row1['pendidikan_pmks']=='SD') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>SD</option>
                                <option value="SMP" <?php  if ($row1['pendidikan_pmks']=='SMP') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>SMP</option>
                                <option value="SMA/SMK" <?php  if ($row1['pendidikan_pmks']=='SMA/SMK') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>SMA/SMK</option>
                                <option value="S1" <?php  if ($row1['pendidikan_pmks']=='S1') {
                                                echo "selected";
                                              }else{
                                                echo "";
                                              }?>>S1</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="id_kat_pmks" name="id_kat_pmks">
                                ...
                                foreach ($kat as $key) :?>
                                <option value="<?=$key['id_kat_pmks']?>" <?php  if ($row1['nm_kat']==$key['nm_kat']) {
                                      echo "selected";
                                    }else{
                                      echo "";
                                    }?>>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="id_program" name="id_program">
                                ...
                                foreach ($kat as $key) :?>
                                <option value="<?=$key['id_program']?>" <?php  if ($row1['nm_program']==$key['nm_program']) {
                                      echo "selected";
                                    }else{
                                      echo "";
                                    }?>>
