...
<div class="container-fluid">
    ...
    <div class="card shadow mb-2">
        <div class="card-header py-3">
            ...
            <!-- Modal Edit Data -->
            <?php foreach ($kec as $row)  : ?>
            <div class="modal fade" id="modalEdit<?=$row['id_kec'] ?>" tabindex="-2" role="dialog"
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <form>
                                    ...
                                    <input type="hidden" name="id_kec" class="form-control"
                                        value="<?=$row['id_kec'] ?>">
                                    <!-- Data lama -->
                                    <input type="hidden" name="nm_kec2" class="form-control"
                                        value="<?=$row['nm_kec']?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mt-1" id="nm_kec" name="nm_kec"
                                            value="<?=$row['nm_kec'] ?>" required>
                                    </div>
