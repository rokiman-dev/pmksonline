...
<head>
  ...
  <link rel="icon" type="image/png" href="../assets/img/logopegawai.png"/>
  ...
  <div id="wrapper" id="menu">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color:#003e51">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div>
          <img class="size" src="../assets/img/logopegawai.png">
        </div>
        <div class="sidebar-brand-text mx-3">DATA PMKS <h6>Kab.Tegal</h6></div>
      </a>
